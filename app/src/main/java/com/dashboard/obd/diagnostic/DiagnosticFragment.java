...
import com.dashboard.obd.driving.DrivingService;
...
public class DiagnosticFragment extends Fragment implements View.OnClickListener/*, DialogFragmentInterface.OnClickListener*/ {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mVehicleLayerDrawable = (LayerDrawable) ContextCompat.getDrawable(this.requireContext(),R.drawable.layer_diagnostic);

        if (getArguments() != null) {
            mShowDiagnosticProcess = getArguments().getBoolean("show-dialog");
            String mDtc = getArguments().getString("dtc");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.btn_refresh).setOnClickListener(v -> showDiagnosticProcess());

        view.findViewById(R.id.btn_reset).setOnClickListener(v -> {
            if (mVss > 0) {
                DrivingWarningFragment.newInstance().show(getChildFragmentManager(), DrivingWarningFragment.TAG);
            } else {
                DtcResetWarningFragment.newInstance().show(getChildFragmentManager(), DtcResetWarningFragment.TAG);
            }
        });
    ...
    public void onClick(View v) {
        ...
        DiagnosticDetailFragment.newInstance(mDtcParser.bindDtcGroup(groupId), groupId).show(getChildFragmentManager(), DiagnosticDetailFragment.TAG);
    ...
    private void showDiagnosticProcess() {
        ...
        mDiagnosticProcess = DiagnosticProcess.newInstance(requireActivity(), mDtcParser.getDtc(), dialog -> update());
    ...
    private void initLayer() {
        mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_chassis, ContextCompat.getDrawable(requireContext(),R.drawable.parts1_b));
        mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_transmission, ContextCompat.getDrawable(requireContext(),R.drawable.parts2_b));
        mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_electronic_circuit,ContextCompat.getDrawable(requireContext(),R.drawable.parts3_b));
        mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_network, ContextCompat.getDrawable(requireContext(),R.drawable.parts4_b));
        mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_engine, ContextCompat.getDrawable(requireContext(),R.drawable.parts5_b));
        mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_exhaust, ContextCompat.getDrawable(requireContext(),R.drawable.parts6_b));
        mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_electronic_device, ContextCompat.getDrawable(requireContext(),R.drawable.parts7_b));
    ...
    private void setFaultLayerByGroupId(int groupId) {
        ...
        switch (groupId) {
            case DtcParser.DTC_GROUP_01:
                mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_exhaust, ContextCompat.getDrawable(requireContext(),R.drawable.parts6_r));
                break;
            case DtcParser.DTC_GROUP_02:
            case DtcParser.DTC_GROUP_03:
            case DtcParser.DTC_GROUP_04:
            case DtcParser.DTC_GROUP_07:
                mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_engine, ContextCompat.getDrawable(requireContext(),R.drawable.parts5_r));
                break;
            case DtcParser.DTC_GROUP_05:
                mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_electronic_circuit, ContextCompat.getDrawable(requireContext(),R.drawable.parts3_r));
                break;
            case DtcParser.DTC_GROUP_06:
                mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_transmission, ContextCompat.getDrawable(requireContext(),R.drawable.parts2_r));
                break;
            case DtcParser.DTC_GROUP_08:
                mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_electronic_device, ContextCompat.getDrawable(requireContext(),R.drawable.parts7_r));
                break;
            case DtcParser.DTC_GROUP_09:
                mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_chassis, ContextCompat.getDrawable(requireContext(),R.drawable.parts1_r));
                break;
            case DtcParser.DTC_GROUP_10:
                mVehicleLayerDrawable.setDrawableByLayerId(R.id.item_network, ContextCompat.getDrawable(requireContext(),R.drawable.parts4_r));
                break;
        }
    }
...
//        filter.addAction(VehicleDataBroadcaster.ACTION_OBD_CLEAR_STORED_DTC);
        ...
        LocalBroadcastManager.getInstance(requireActivity()).registerReceiver(mVehicleReceiver, filter);
    }

    private void unregisterVehicleReceiver() {
        try {
            LocalBroadcastManager.getInstance(requireActivity()).unregisterReceiver(mVehicleReceiver);
        } catch (Exception e) {
        }
    }
...
//                onReadyToExit();
    ...
    public static final class DiagnosticDetailFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            View v = LayoutInflater.from(requireActivity()).inflate(R.layout.dialog_diagnostic_detail, null);
            setTitleText(v.findViewById(R.id.title), getArguments().getInt("detail-id"));
            setDtcText(v.findViewById(R.id.dtc), getArguments().getString("detail-dtc"));
            setMessageText(v.findViewById(R.id.message), getArguments().getInt("detail-id"));
            ...
            AlertDialog dialog = new AlertDialog.Builder(requireActivity())//, R.style.AppTheme_Dialog_Transparent)
                    .setView(v)
                    .create();
    ...
    public static class DtcResetWarningFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            try {
                mOnClickListener = (DialogFragmentInterface.OnClickListener) requireActivity();
            } catch (ClassCastException e) {
                throw new ClassCastException(requireActivity() + " must implement DialogFragmentInterface");
            }
            final View view = LayoutInflater.from(requireActivity()).inflate(R.layout.dialog_dtc_reset, null);
