...
public class DiagnosticDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // Message
        mMessageText = mView.findViewById(R.id.text);
        mMessageText.setText(getString(R.string.dialog_diagnostic_msg));
        mView.findViewById(R.id.btn_cancel).setOnClickListener(this);

        Dialog dialog = new AlertDialog.Builder(requireActivity(), R.style.AppTheme_Dialog_Transparent)
                .setView(mView)
                ...
                .setOnDismissListener(dialog12 -> {
                    ...
                    if (fragment instanceof DiagnosticFragment) {
    ...
    private void updateResult() {
        ...
        mView.findViewById(R.id.ani_scan).setOnClickListener(v -> {
