...
import com.dashboard.obd.diagnostic.DiagnosticProcess;
...
public class DrivingService extends Service {
    ...
    public static final String EXTRA_ERS_TARGET
            = "com.dashboard.obd.extra.ERS_TARGET";
    public static final String EXTRA_USER_SELECT
            = "com.dashboard.obd.extra.USER_SELECT";
...
//    public static final String ACTION_GOTO_DIAGNOSTIC = "com.dashboard.obd.action.GOTO_DIAGNOSTIC";
