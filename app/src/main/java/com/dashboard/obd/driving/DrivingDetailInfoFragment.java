...
import com.dashboard.obd.util.TextViewUtils;
import com.dashboard.obd.R;
import com.dashboard.obd.util.Unit;
...
public class DrivingDetailInfoFragment extends Fragment implements ViewPager.OnPageChangeListener {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        int padding = (int) dp2px(requireActivity(), 4);
    ...
    public static class PageFragment extends Fragment {
        ...
        private static final int MASS_AIR_FLOW = 411;
        private static final int MAN_ABS_PRESS = 412;
        private static final int FUEL_RAMP_PRESSURE_D = 413;
        private static final int TIMING_ADVANCE =421 ;
        private static final int LOAD_ABS = 422;
        private static final int CONTROL_MODULE_VOLTAGE =423 ;
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            switch (mPage) {
                ...
                case 2: // Page 3: FUEL_ECONOMY ~ IDLE_TIME
                    setupPage3(view);
                    break;
                case 3: // Page 3: FUEL_ECONOMY ~ IDLE_TIME
                    setupPage4(view);
                    break;
                default:
                    break;
...
//            vv.getIconView().setImageResource(R.drawable.ico_idle_gray);
        ...
        private void setupPage4(View view) {
            mValues.put(MASS_AIR_FLOW, (ValueView) view.findViewById(R.id.value_11));
            mValues.put(MAN_ABS_PRESS, (ValueView) view.findViewById(R.id.value_12));
            mValues.put(FUEL_RAMP_PRESSURE_D, (ValueView) view.findViewById(R.id.value_13));

            mValues.put(TIMING_ADVANCE, (ValueView) view.findViewById(R.id.value_21));
            mValues.put(LOAD_ABS, (ValueView) view.findViewById(R.id.value_22));
            mValues.put(CONTROL_MODULE_VOLTAGE, (ValueView) view.findViewById(R.id.value_23));

            ValueView vv = mValues.get(MASS_AIR_FLOW);
            vv.getTitleView().setText("Mass airflow");
            vv.getUnitView().setText(Unit.GS.toString());

            vv = mValues.get(MAN_ABS_PRESS);
            vv.getTitleView().setText("Intake MAP");
            vv.getUnitView().setText(Unit.KPA.toString());

            vv = mValues.get(FUEL_RAMP_PRESSURE_D);
            vv.getTitleView().setText(R.string.driving_value_fule_pressure);
            vv.getUnitView().setText(Unit.KPA.toString());

            vv = mValues.get(TIMING_ADVANCE);
            vv.getTitleView().setText("Timing advance");
            vv.getUnitView().setText(Unit.GRAD.toString());

            vv = mValues.get(LOAD_ABS);
            vv.getTitleView().setText("Abs. eng. load");
            vv.getUnitView().setText(Unit.PERCENT.toString());

            vv = mValues.get(CONTROL_MODULE_VOLTAGE);
            vv.getTitleView().setText("Control module Voltage");
            vv.getUnitView().setText(Unit.VOLT.toString());
...
//            }
        ...
        private void onObdDataReceivedPage4(ObdData data) {
            ValueView vv;

            if (data.isValid(KEY.SAE_MAF)) {
                vv = mValues.get(MASS_AIR_FLOW);
//                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.TRIP_FUEL_ECONOMY)));
                vv.getValueView().setText(String.format("%d", data.getFloat(KEY.SAE_MAF).intValue()));

            }
            if (data.isValid(KEY.SAE_MAP)) {
                vv = mValues.get(MAN_ABS_PRESS);
//                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.TRIP_FUEL_CONSUMPTION)));
                vv.getValueView().setText(String.format("%d", data.getInteger(KEY.SAE_MAP)));

            }
            if (data.isValid(KEY.SAE_FRP_D)) {
                vv = mValues.get(FUEL_RAMP_PRESSURE_D);
//                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.TRIP_CO2)));
                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.SAE_FRP_D).floatValue()));
            }
            if (data.isValid(KEY.SAE_TA)) {
                vv = mValues.get(TIMING_ADVANCE);
//                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.TRIP_FUEL_ECONOMY)));
                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.SAE_TA).floatValue()));

            }
            if (data.isValid(KEY.SAE_LOAD_ABS)) {
                vv = mValues.get(LOAD_ABS);
//                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.TRIP_FUEL_CONSUMPTION)));
                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.SAE_LOAD_ABS).floatValue()));

            }
            if (data.isValid(KEY.SAE_CMV)) {
                vv = mValues.get(CONTROL_MODULE_VOLTAGE);
//                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.TRIP_CO2)));
                vv.getValueView().setText(String.format("%.1f", data.getFloat(KEY.SAE_CMV).intValue()));
            }
//
        }
